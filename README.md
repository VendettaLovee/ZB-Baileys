...
```
yarn add @VendettaLovee/ZB-Baileys
```
...
```ts 
import makeWASocket from '@VendettaLovee/ZB-Baileys'
```
...
```ts
import makeWASocket, { useMultiFileAuthState } from '@VendettaLovee/ZB-Baileys'
...
```ts
import makeWASocket, { DisconnectReason, useMultiFileAuthState } from '@VendettaLovee/ZB-Baileys'
...
```ts
import makeWASocket, { useSingleFileAuthState, useMongoFileAuthState } from '@VendettaLovee/ZB-Baileys'
...
import { makeInMemoryStore, getAggregateVotesInPollMessage } from '@VendettaLovee/ZB-Baileys';
...
```ts
import makeWASocket, { makeInMemoryStore } from '@VendettaLovee/ZB-Baileys'
...
import { downloadMediaMessage, getContentType } from '@VendettaLovee/ZB-Baileys'
